...
from . import res_currency_rate_provider_CSOB
from . import res_currency_rate_provider_UNICREDIT
from . import res_currency_rate_provider_KB
from . import res_currency_rate_provider_mBank